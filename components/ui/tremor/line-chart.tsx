...
} from "@/lib/app/chartUtils";
import { useOnWindowResize } from "@/hooks/useOnWindowResize";
import { percentageFormatter, getBadgeType } from "@/lib/app/utils";
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-gray-800 text-sm  dark:fill-gray-200"
                >
                  {xAxisLabel}
                </Label>
              )}
            ...
            {categories.map((category) => (
              <Line
                className={"stroke stroke-orange-400"}
                strokeOpacity={
