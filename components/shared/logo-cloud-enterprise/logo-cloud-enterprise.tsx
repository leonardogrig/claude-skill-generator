...
import "./logo-cloud-enterprise.css";
import MarqueeAnimation from "@/components/ui/motion/marquee-animation";

export default function LogocloudEnterprise() {
              ...
              {logoIndices.map((logoIndex, i) => (
                ...
                >
                  <Image
                    ...
                    src={`logocloud-enterprise/${logoIndex}`}
                    raw
                    loading="eager"
                    decoding="async"
                  />
