...
import { focusInput, focusRing, hasErrorInput } from "@/lib/app/utils";
    ...
    return (
      <PopoverPrimitives.Trigger asChild>
        <button
          ...
          {...props}
        >
          <RiCalendar2Fill className="size-4 shrink-0 text-zinc-500 dark:text-zinc-400" />
          <span className="flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-left text-zinc-500 dark:text-zinc-400 text-xs">
            {children ? (
              children
            ) : placeholder ? (
        ...
        return (
          <li key={index} className="sm:w-full sm:py-px">
            <button
              ...
              className={cn(
                // base
                "relative w-full overflow-hidden text-ellipsis whitespace-nowrap rounded border px-2.5 py-1.5 text-left text-base outline-none transition-all sm:border-none sm:py-2 sm:text-sm",
                // text color
            ...
            <div>
              ...
              <div className="border-t border-gray-200 p-3 sm:flex sm:items-center sm:justify-between dark:border-gray-800">
                <p className="tabular-nums text-gray-900 dark:text-gray-50">
                  ...
                  <span className="">{displayRange}</span>
                </p>
                <div className="mt-2 flex items-center gap-x-2 sm:mt-0">
                  ...
                  <Button
                    variant="primary"
                    className="h-8 w-full sm:w-fit bg-black dark:bg-black-50 hover:bg-black/[0.8]"
                    type="button"
                    onClick={onApply}
                  >
                    {translations?.apply ?? "Apply"}
