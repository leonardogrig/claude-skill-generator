      ...
      <PortalToBody>
        <AnimatePresence initial={false} mode="popLayout">
          {hovering && (
            <div
              className={cn(
                "fixed pointer-events-none flex-center z-[500]",
                wrapperClassName,
              )}
              style={{
                left: bounds?.x,
            ...
            >
              <motion.div
                ...
                className={cn(
                  "py-10 px-16 rounded-12 max-w-248 absolute w-max text-body-medium text-accent-white bg-black-alpha-64 backdrop-blur-[6px] z-[500]",
                  className,
                )}
